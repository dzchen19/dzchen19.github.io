...
As of September 2025, all papers are currently under submission, Drafts are available upon request via email.
---

### **Exploring the Healthy Immigrant Effect: Does This Hypothesis Apply to China?**
*Job Market Paper*
...
### **The Cost of Absence: Parental Migration, Remittances, and Child Health in Rural China**
*Working Paper*

Uses CFPS panel data and instrumental variable estimation to examine whether remittances compensate for the health impacts of parental absence on left-behind children in rural China. Employsdistinct measures of physical and mental health.  

---

### **The Impact of Return Migration on Subjective Well-Being: Evidence from Rural China**
*Working Paper*

Uses first-difference estimation to assess changes in subjective well-being after return migration. Distinguishes between recent and long-term returnees. Constructs a GHQ-12-based index to evaluate post-return well-being and its underlying mechanisms.  
...
### **• Refugee Inflows and Child Development: Evidence from a Multi-Country Panel**
- *With Yu Qin*
